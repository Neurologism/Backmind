...
export const followHandler = async (body: any, req: Request, res: Response) => {
  ...
  const userToFollow = await UserModel.findById(body.userId);
  ...
  user.followingIds.push(body.userId);
  await user.save();
