...
router.post('/model/training-start', dbMiddleware, authMiddleware, modelStartTraining);
router.post('/model/training-stop', dbMiddleware, authMiddleware, modelStopTraining);
router.post(
  '/model/training-status',
  dbMiddleware, authMiddleware, modelStatusTraining
);
